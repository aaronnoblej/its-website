...
//This page is what connects to database, checks the values from the database, and creates the session.
   ...
   $mypassword = strval($_GET['password']);
	...
	// echo"b4if";
		...
		//echo $myusername;
		//echo $mypassword;
		$sql = "SELECT UserUsername, GroupNo, UserPassword, FirstName, LastName FROM jamieweb_peak_database.User WHERE UserUsername = '".$myusername."' and UserPassword = '".$mypassword."'";
		//echo $sql;
