...
if(isset($_POST['submit'])) {
  ...
  function validatePHP() {
    if($_POST['user_status'] == 'Choose One' || empty($_POST['summary'])) {
...
<div class="container"> 
  ...
  <section class="content" id="content">
    ...
    <hr>
	<h1>Concordia Google Drive Password Reset Request</h1>
	<br>
    <form id="woform" name="woform" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return validate();">
      <p class="form-fields"> 
        ...
        <textarea id="summary" name="summary" style="height:200px" onchange="undoColor('summary')">Requesting Google Drive password reset.</textarea>
        <br></div>
