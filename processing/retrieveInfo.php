...
$db->disconnect();
echo $info . "<br><br><h4>Technician Notes:</h4>
  <form action=\"../admin/active_wo.php\" method=\"post\">
    <input type=\"hidden\" name=\"wo_num\" value=\"" . $result[0]['WorkOrder'] . "\">
    <input type=\"hidden\" name=\"email_recipient\" value=\"" . $result[0]['Email'] . "\">
    <input type=\"hidden\" name=\"issue_description\" value=\"" . $result[0]['IssueSummary'] . "\">
    <textarea rows=\"10\" cols=\"80\" placeholder=\"Add notes here...\" name=\"tech_notes\">" . $result[0]["TechnicianNotes"] . "</textarea><br>
    <label><input type='checkbox' name='email_update'> Send an email to the requestor of the above notes.</label><br><br>
    <input type='submit' value='Save' name='tech_notes_submit'>
  </form>";
?>